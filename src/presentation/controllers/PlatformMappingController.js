...
class PlatformMappingController {
  ...
  async testConnection (req, res) {
    try {
      ...
      const testResult = await this.platformMappingService.testConnection(mappingId)
  ...
  async testPlatformConnection (req, res) {
    try {
      ...
      const testResult = await this.platformMappingService.testPlatformConnection(platform, component, testData)
